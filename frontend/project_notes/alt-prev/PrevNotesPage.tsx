...
import NoteForm from '../../src/pages/notes-page/components/NoteForm'
import { NotesDataTable } from '@/pages/notes-page/components/table/NotesDataTable'
import { Note } from '@/types/types'
import { columns } from '../../src/pages/notes-page/components/table/columns'
...
export default function NotesPage() {
  ...
  const previousNoteContent = useAppSelector(
    (state) => state.notes.currentNote?.noteContent,
  )
  if (currentNote !== null) {
  ...
  The value of currentNote, after being passed into JSON.stringify, is now ${JSON.stringify(
    currentNote,
    null,
    2,
  )}
