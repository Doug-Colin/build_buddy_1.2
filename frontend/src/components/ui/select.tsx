...
/*It seems shadcn <Select> component is not passing name attribute down to the udnerlying html <select> element.
    -this shows up as an issue in Chrome devtools
    -may be an issue already opened on shadcn repo but I didn't find it
*/
