...
import { ResponsiveDataTable } from './components/table/ResponsiveDataTable'
    ...
    <Layout>
      <>
        ...
        <div className="h-full flex-1 flex-col space-y-8 p-1.5 md:flex md:p-8 ">
          <div className="flex items-center justify-between space-y-2">
            <div>
              <h2 className="text-2xl font-bold tracking-tight">
                Modularize and responsify datatable component!
              </h2>
              <p className="text-muted-foreground">
                Here is a list of your ____ for this month!
              </p>
            </div>
          ...
          <ResponsiveDataTable<Task, any> columns={taskColumns} data={tasks} />
        </div>
      </>
    </Layout>
  )
