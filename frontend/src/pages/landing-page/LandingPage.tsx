...
export default function LandingPage() {
  ...
  const projectsIcon =
    theme === 'dark' ? projectsIconDarkMode : projectsIconLightMode
  const barchartIcon =
    theme === 'dark' ? barchartIconDarkMode : barchartIconLightMode
  const estimateIcon =
    theme === 'dark' ? estimateIconDarkMode : estimateIconLightMode
      ...
      <main>
        <section className="flex flex-col items-center space-x-4">
          ...
          <p className="max-w-[500px] text-muted-foreground text-xl mb-4">
            Being a small scale artist, craftsman, or manufacturer is full of
            challenges, and building a well functioning and good looking product
            is only one of them.
          </p>
          <p className="max-w-[500px] text-muted-foreground text-xl mb-4">
            Build Buddy helps you take care of the annoying parts of running a
            small business so that you can spend more time doing what you do
            best- building.
          </p>
          ...
          <h2 className="text-3xl mb-3">
            More time building. Less time administering.
          </h2>
          <p className="mb-8">
            Build Buddy saves you time by by making the the chores of running a
            small business easy:
          </p>
